...
[![NuGet](https://img.shields.io/badge/NuGet-0.2.0-blue.svg?style=for-the-badge)](https://www.nuget.org/packages/Synnotech.DatabaseAbstractions/)
...
- **Package Reference in csproj**: `<PackageReference Include="Synnotech.Core" Version="0.2.0" />`S
